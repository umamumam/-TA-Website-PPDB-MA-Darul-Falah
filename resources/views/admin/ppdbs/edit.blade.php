...
<br>
	...
	{{ Form::model($ppdb, array('route' => array('ppdbs.update', $ppdb->id), 'method' => 'PUT')) }}
		...
		<div class="mb-3">
			{{ Form::label('jenis_kelamin', 'Jenis_kelamin', ['class'=>'form-label']) }}<br>
		...
		<div class="mb-3">
			{{ Form::label('anak_ke', 'Anak_ke', ['class'=>'form-label']) }}
		...
		<div class="mb-3">
			...
			<select name="kriteria_peserta" id="kriteria_peserta" class="form-control" required>
				<option value="Siswa_Baru"{{ $ppdb->jenis_kelamin === 'Siswa_Baru' ? 'selected' : '' }}>Siswa_Baru</option>
				<option value="Siswa_Lama"{{ $ppdb->jenis_kelamin === 'Siswa_Lama' ? 'selected' : '' }}>Siswa_Lama</option>
			</select>
		</div>
		<div class="mb-3">
